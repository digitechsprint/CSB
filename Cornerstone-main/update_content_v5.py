...
(function() {
    ...
    const translations = {
        ...
        "SERVICES": "Services",
        "ABOUT": "About Us",
        "Contact us": "Book A Consultation", // The original nav had 'Contact us' as the button
        "Home": "Home",
        "Blog": "Blog",
        "Contact Us": "Contact Us",
        "Book A Consultation": "Book A Consultation",
        
        // Hero Mappings (Matching Image 3 & Image 2 requested content)
...
def process_file(filepath):
    ...
    # Clean up previous scripts (v3 and v4 artifacts)
    ...
    with open(filepath, 'w', encoding='utf-8') as f:
        f.write(content)
    print(f"Injected clean translator into: {filepath}")
